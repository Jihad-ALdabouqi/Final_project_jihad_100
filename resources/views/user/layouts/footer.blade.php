            ...
            <div class="row g-5">
                <div class="col-lg-6 pe-lg-5">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="display-5 text-primary mb-0"><i class="bi bi-scissors"></i>Luxury Salons</h1>
                    </a>
                    <p> Your gateway to Jordan’s finest women’s beauty experiences. We connect you with elite salons across Amman, Irbid, Aqaba, and beyond — where elegance meets perfection.<p>
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-2"></i>Jordan , Amman</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-2"></i>+962 7 8290 1115</p>
                    <p><i class="fa fa-envelope me-2"></i>luxury_salons@gmail.com</p>
